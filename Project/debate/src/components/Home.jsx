...
export default function App() {
  return (
    <div className="snap-y snap-mandatory min-h-screen overflow-y-scroll scroll-smooth">
      {/* Header Section */}
      <section className="h-screen flex flex-col items-center justify-center bg-gradient-to-br from-blue-50 to-blue-200 text-center snap-start">
        <h1 className="text-5xl font-bold mb-4">Welcome to DebateAI</h1>
      ...
      {steps.map((step) => (
        <section
          key={step.id}
          className="h-screen flex flex-col items-center justify-center text-center bg-white snap-start"
        >
      ...
      {/* Contact Section */}
      <section className="h-screen flex flex-col items-center justify-center bg-blue-600 text-white snap-start">
